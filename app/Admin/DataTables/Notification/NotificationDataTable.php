...
class NotificationDataTable extends BaseDataTable
{
    ...
    public function getView()
    {
        return [
            ...
            'checkbox' => 'admin.notification.datatable.checkbox',
        ];
    }
    /**
    ...
    {
        $this->instanceDataTable = $this->instanceDataTable->rawColumns(['checkbox','title','fullname', 'status', 'desc', 'created_at',  'action']);
    }
