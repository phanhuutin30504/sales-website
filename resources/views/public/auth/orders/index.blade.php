    ...
    <div class="information-orders">
        <div class="card-header mb-3">
            <ul class="nav nav-tabs card-header-tabs nav-fill nav-order-status" data-bs-toggle="tabs" role="tablist">
                ...
                <li class="nav-item" role="presentation">
                    <a href="#" class="nav-link{{ request()->query('status') == $key ? ' active' : '' }}" data-status="{{ $key }}">
                        {{ $value }}
                    </a>
                </li>
                @endforeach
        ...
        <div class="card-body">
            ...
            <div id="loading" class="align-items-center justify-content-center py-4 my-3 text-center"
                style="display: none">
